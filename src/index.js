...
const createResultWindow = () => {
  ...
  const resultWindow = new BrowserWindow({
    ...
    webPreferences: {
			nodeIntegration: true,
      preload: path.join(__dirname, './resultWindow/preload.js')
  ...
  // and load the index.html of the app.
  resultWindow.loadFile(path.join(__dirname, './resultWindow/index.html'));
...
ipcMain.on('asynchronous-message', (event, arg) => {
  ...
  resultWindow.webContents.send('fetchingDataFromMain', arg)
});
